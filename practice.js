...
var reversedLooper = letters =>
{
  ...
  {
    alert(letters[letters.length-1-i]);
  }
}
////////// PROBLEM 5 //////////
...
var evenFinder = nums => nums.filter(element=>element%2==0);
...
var divider = numbersArray => [numbersArray.filter(element=>element%2==0), numbersArray.filter(element=>element%2==1)];
...
var removeItem = (myGroceryList, item) => myGroceryList && item?myGroceryList.filter(element=>element!=item):[];

var addItem = (myGroceryList, item) =>
{
  if (myGroceryList && item)
  {
    if (myGroceryList.find(element=>element == item) == 0 || myGroceryList.find(element=>element == item))
    {
...
var longer = (arr1,arr2) => arr2.length > arr1.length?arr2:arr1;
...
{
  name: "Harry Potter",
  email: "boyWhoLived@coldmail.com",
  password: "quidditch",
  username: "chosenOne"
}
